    ...
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <router-link to="/landing" class="dropdown-item">Contact us</router-link>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://www.facebook.com/higorfchagas" target="_blank"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://www.instagram.com/higorfchagas"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://twitter.com/higorfchagas" target="_blank"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://github.com/higorfchagas"
